...
std::unordered_map<std::string, Item> store_map = {
    ...
    {"start_pose", {"start_pose", -1, 0.0, 0.0, 0.0, 0, true}},
    {"final_pose", {"final_pose", -2, 0.0, 0.0, 0.0, 0, true}},

    {"item_a", {"a", 2, 3.4, 0.0, 0.0, 1, true}},
    {"item_b", {"a", 3, 6.7, 0.0, 0.0, 1, false}},
    {"item_c", {"a", 3, 4.1, 0.0, 0.0, 1, true}},
    {"item_d", {"a", 3, 1.3, 0.0, 0.0, 1, true}},
    {"item_e", {"a", 5, 7.8, 0.0, 0.0, 1, false}},
    {"item_f", {"a", 5, 8.5, 0.0, 0.0, 1, true}},
