...
// Use an inline function to return a static map, avoiding initialization issues.
inline const std::unordered_map<std::string, int>& get_wav_map() {
    static const std::unordered_map<std::string, int> wav_map_instance = {
